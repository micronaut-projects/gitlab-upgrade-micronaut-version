...
upgradeSingleBranchRepo "micronaut-aws-app-graal micronaut-basic-app micronaut-cache-graal micronaut-cassandra-graal \
       micronaut-elasticsearch-graal micronaut-graphql-graal micronaut-function-aws-graal micronaut-grpc-graal micronaut-introspected-graal \
       micronaut-kafka-graal micronaut-kotlin-graal micronaut-management-graal micronaut-rabbitmq-graal micronaut-redis-graal micronaut-schedule-graal \
